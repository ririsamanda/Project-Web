...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark mb-0">
            <i class="bi bi-pencil-square me-2 text-warning"></i> Edit Produk
        </h2>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            ...
            <form action="{{ route('produk.update',$produk->id_produk) }}" method="POST">
                ...
                <h5 class="mb-3 text-muted border-bottom pb-2">Informasi Produk</h5>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input name="kode_produk" id="kode_produk" class="form-control" value="{{ old('kode_produk', $produk->kode_produk) }}" readonly>
                    </div>
                    <small class="text-muted">Kode produk tidak dapat diubah setelah dibuat.</small>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input name="nama_produk" id="nama_produk" class="form-control" value="{{ old('nama_produk', $produk->nama_produk) }}" required>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="kategori" id="kategori" class="form-control" value="{{ old('kategori', $produk->kategori) }}">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="satuan" id="satuan" class="form-control" value="{{ old('satuan', $produk->satuan) }}">
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input name="harga" id="harga" type="number" class="form-control" value="{{ old('harga', $produk->harga) }}">
                    </div>
